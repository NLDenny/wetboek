...
#####<span style="color: #A67C3D;">Artikel 1 | Legaliteitsbeginsel</span>
```
Strafvordering heeft alleen plaats op de wijze bij de wet voorzien.
```

#####<span style="color: #A67C3D;">Artikel 2 | Relatieve competentie</span>
```
Van de rechtbanken zijn gelijkelijk bevoegd:
die binnen welker rechtsgebied het feit is begaan.
```

#####<span style="color: #A67C3D;">Artikel 9 | Vervolging door DA</span>
```
...
#####<span style="color: #A67C3D;">Artikel 27 | Verdachte</span>
```
...
#####<span style="color: #A67C3D;">Artikel 27a | Vaststellen identiteit</span>
```
...
#####<span style="color: #A67C3D;">Artikel 27c | Mededelen van rechten aan verdachte</span>
```
...
#####<span style="color: #A67C3D;">Artikel 27cb | Plaats van verhoor</span>
```
...
#####<span style="color: #A67C3D;">Artikel 27d | Getuige of verdachte</span>
```
...
#####<span style="color: #A67C3D;">Artikel 27e | Informeren naasten</span>
```
...
#####<span style="color: #A67C3D;">Artikel 28 | Bijstand door raadsman</span>
```
...
#####<span style="color: #A67C3D;">Artikel 28a | Afstand van rechtsbijstand</span>
```
...
#####<span style="color: #A67C3D;">Artikel 28c | Overleg met raadsman vóór verhoor</span>
```
...
#####<span style="color: #A67C3D;">Artikel 28d | Bijwonen verhoor door raadsman</span>
```
...
#####<span style="color: #A67C3D;">Artikel 29 | Verklaringsvrijheid en zwijgrecht</span>
```
...
#####<span style="color: #A67C3D;">Artikel 29b | Tolk</span>
```
...
#####<span style="color: #A67C3D;">Artikel 29c | Vaststellen identiteit bij verhoor</span>
```
...
#####<span style="color: #A67C3D;">Artikel 29e | Horen van verdachte</span>
```
...
#####<span style="color: #A67C3D;">Artikel 30 | Kennisneming processtukken</span>
```
...
#####<span style="color: #A67C3D;">Artikel 37 | Toelating als raadslieden</span>
```
...
<!--
#####<span style="color: #A67C3D;">Artikel 37 | Toelating als raadslieden
```
...
#####<span style="color: #A67C3D;">Artikel 38 | Keuze raadsman</span>
```
...
#####<span style="color: #A67C3D;">Artikel 51a | Begripsbepaling</span>
```
...
#####<span style="color: #A67C3D;">Artikel 51ac | Informeren over voortgang strafzaak</span>
```
...
#####<span style="color: #A67C3D;">Artikel 51c | Bijstand en vertegenwoordiging</span>
```
...
#####<span style="color: #A67C3D;">Artikel 51e | Spreekrecht</span>
```
...
#####<span style="color: #A67C3D;">Artikel 52 | Staande houden</span>
```
...
#####<span style="color: #A67C3D;">Artikel 53 | Aanhouding bij heterdaad</span>
```
...
#####<span style="color: #A67C3D;">Artikel 54 | Aanhouding buiten heterdaad</span>
```
...
#####<span style="color: #A67C3D;">Artikel 55 | Betreding plaats ter aanhouding</span>
```
...
#####<span style="color: #A67C3D;">Artikel 55b | Bevoegdheden bij aanhouding</span>
```
...
#####<span style="color: #A67C3D;">Artikel 55c | Vaststellen identiteit verdachte</span>
```
...
#####<span style="color: #A67C3D;">Artikel 55d | Middelenonderzoek</span>
```
...
#####<span style="color: #A67C3D;">Artikel 95 | Inbeslagneming bij aanhouden of staande houden</span>
```
...
#####<span style="color: #A67C3D;">Artikel 96 | Inbeslagnemingsbevoegdheid opsporingsambtenaar</span>
```
...
#####<span style="color: #A67C3D;">Artikel 96b | Doorzoeking vervoermiddel</span>
```
...
#####<span style="color: #A67C3D;">Artikel 96c | Doorzoeking van plaatsen</span>
```
...
#####<span style="color: #A67C3D;">Artikel 97 | Doorzoeking zonder toestemming bewoner</span>
```
In geval van ontdekking op heterdaad van een strafbaar feit of in geval van 
verdenking van een misdrijf waarop een lange gevangenisstraf is gesteld, 
...
#####<span style="color: #A67C3D;">Artikel 99a | Recht op bijstand raadsman</span>
```
...
#####<span style="color: #A67C3D;">Artikel 126g | Stelselmatig volgen en kijkoperatie
...
#####<span style="color: #A67C3D;">Artikel 127 | Opsporingsambtenaar</span>
```
Onder opsporingsambtenaren worden verstaan alle personen met de opsporing van 
het strafbare feit belast.
```

#####<span style="color: #A67C3D;">Artikel 128 | Ontdekking op heterdaad</span>
```
...
#####<span style="color: #A67C3D;">Artikel 129 | Misdrijf</span>
```
...
#####<span style="color: #A67C3D;">Artikel 141 | Ambtenaren met algemene opsporingsbevoegdheid</span>
```
...
#####<span style="color: #A67C3D;">Artikel 148 | Taak DA bij opsporing</span>
```
...
#####<span style="color: #A67C3D;">Artikel 149 | Opsporingsonderzoek</span>
```
...
#####<span style="color: #A67C3D;">Artikel 149a | Samenstelling processtukken</span>
```
...
#####<span style="color: #A67C3D;">Artikel 152 | Opmaken proces-verbaal</span>
```
...
#####<span style="color: #A67C3D;">Artikel 153 | Op ambtseed & Ondertekening</span>
```
...
#####<span style="color: #A67C3D;">Artikel 161 | Bevoegdheid tot aangifte</span>
```
Ieder die kennis draagt van een begaan strafbaar feit is bevoegd daarvan 
aangifte of klachte te doen.
```

#####<span style="color: #A67C3D;">Artikel 163 | Wijze van aangifte</span>
```
...
#####<span style="color: #A67C3D;">Artikel 164 | Klachtdelicten</span>
```
...
#####<span style="color: #A67C3D;">Artikel 167 | Opportuniteitsbeginsel</span>
```
...
#####<span style="color: #A67C3D;">Artikel 173 | Verklaringsvrijheid</span>
```
...
#####<span style="color: #A67C3D;">Artikel 258 | Dagvaarding</span>
```
...
#####<span style="color: #A67C3D;">Artikel 261 | Tenlastelegging</span>
```
...
<!--
#####<span style="color: #A67C3D;">Artikel 265 | Dagvaardingstermijn
```
...
#####<span style="color: #A67C3D;">Artikel 266 | Intrekking dagvaarding</span>
```
...
#####<span style="color: #A67C3D;">Artikel 268 | Behandeling door meervoudige kamer</span>
```
...
#####<span style="color: #A67C3D;">Artikel 269 | Zitting openbaar of behandeling met gesloten deuren</span>
```
...
#####<span style="color: #A67C3D;">Artikel 270 | Uitroepen zaak</span>
```
De voorzitter begint het onderzoek door het doen uitroepen van de zaak tegen 
de verdachte.
```

#####<span style="color: #A67C3D;">Artikel 271 | Verklaring in vrijheid afgelegd & Praesumptio innocentiae</span>
```
...
#####<span style="color: #A67C3D;">Artikel 272 | Leiding onderzoek</span>
```
...
#####<span style="color: #A67C3D;">Artikel 273 | Aanvang onderzoek</span>
```
...
#####<span style="color: #A67C3D;">Artikel 277 | Onafgebroken onderzoek</span>
```
...
#####<span style="color: #A67C3D;">Artikel 281 | Schorsing voor (on)bepaalde tijd</span>
```
...
#####<span style="color: #A67C3D;">Artikel 284 | Voordragen zaak</span>
```
De district attorney draagt de zaak voor.
```

#####<span style="color: #A67C3D;">Artikel 286 | Ondervraging verdachte</span>
```
...
#####<span style="color: #A67C3D;">Artikel 301 | Voorlezing van stukken</span>
```
...
#####<span style="color: #A67C3D;">Artikel 302 | Vragen aan spreekgerechtigde</span>
```
...
#####<span style="color: #A67C3D;">Artikel 311 | Requisitoir</span>
```
...
#####<span style="color: #A67C3D;">Artikel 338 | Onmiddellijkheidsbeginsel</span>
```
...
#####<span style="color: #A67C3D;">Artikel 339 | Bewijsmiddelen</span>
```
...
#####<span style="color: #A67C3D;">Artikel 340 | Eigen waarneming rechter</span>
```
...
#####<span style="color: #A67C3D;">Artikel 341 | Verklaring verdachte</span>
```
...
#####<span style="color: #A67C3D;">Artikel 344 | Schriftelijk bescheiden</span> 
```
...
#####<span style="color: #A67C3D;">Artikel 345 | Sluiting onderzoek en tijdstip uitspraak</span>
```
...
#####<span style="color: #A67C3D;">Artikel 351 | Oplegging van straf of maatregel</span>
```
...
#####<span style="color: #A67C3D;">Artikel 352 | Vrijspraak en ontslag van alle rechtsvervolging</span>
```
...
#####<span style="color: #A67C3D;">Artikel 359a | Meeweging verzuim</span>
```
...
#####<span style="color: #A67C3D;">Artikel 362 | Uitspraak van vonnis</span>
```
...
#####<span style="color: #A67C3D;">Artikel 404 | Hoger beroep</span>
```
