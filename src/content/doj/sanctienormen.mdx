...
title: Sanctienormen
order: 3
description: Overzicht van de sanctienormen zoals vastgesteld door het Department of Justice.
---

import MathJax from '../../components/MathJax.astro';

{/*
  Section headings on this page are h2 (not h5 like elsewhere) on purpose:
  unlike "Artikel N"-headings in the wetten, these ARE this page's real
  navigational sections, so they should show up in the TOC.
*/}

<MathJax />

Deze pagina biedt een overzicht van de sanctienormen zoals deze zijn vastgesteld door het [Department of Justice](/department-of-justice/doj/).
...
[Art. 157 Sr](/wetgeving/sr/#artikel-157-opzettelijk-brand-of-ontploffing-veroorzaken) | Opzettelijk brand of ontploffing veroorzaken | 15 maanden GS | $740,- 
...
[Art. 2 Wgbk](/wetgeving/overig/wgvgk/#artikel-2) | Gezichtsbedekking dragen | $390,-
